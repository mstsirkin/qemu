...
$(ber-obj-y): $(GENERATED_HEADERS)
ber-visitor.o : $(ber-obj-y)
ber-visitor: ber-visitor.o ber/ber-common.o ber/ber-input-visitor.o ber/ber-output-visitor.o $(ber-obj-y) qapi/qapi-visit-core.o qemu-qsb.o error.o qdict.o qint.o qfloat.o qlist.o qjson.o json-streamer.o json-lexer.o json-parser.o qerror.o qemu-error.o qemu-tool.o qbool.o qstring.o qemu-file.o
...
-include $(wildcard *.d audio/*.d slirp/*.d block/*.d net/*.d ui/*.d qapi/*.d qga/*.d ber/*.d)
